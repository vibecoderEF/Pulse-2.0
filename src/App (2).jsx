...
function App() {
  ...
  // Pull on mount — if remote data is newer than local, restore it
  useEffect(() => {
    ...
    (async () => {
      ...
      if (row?.data) {
        ...
        // Use remote if it has more workouts logged or was explicitly newer
        const localW  = JSON.parse(localStorage.getItem("pulseV1") || "{}");
        const localTs = localW?._syncedAt || 0;
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    toast("Sync link copied! Open on any device 🔗");
                  } catch {
                    toast(url.toString());
                  }
                }}
